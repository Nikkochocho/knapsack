"""
algorithms/encosta_tentativa.py
===================
Subida de Encosta com tentativa (Hill-Climbing with tolerance).
"""
...
def search(start: str, goal: str, graph: dict,
    ...
    v1 = avalia_caminho(s1, velocidade_entrada=vel)
    ...
    caminho, fitness, vel, tempo = bl.encosta_com_tentativa(
        s1, v1, tmax, vel, tempo_limite=tempo_limite
    )
